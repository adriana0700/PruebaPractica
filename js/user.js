 ...
 function cargarUsuarios() {
     ...
     var url = "http://localhost/prueba/controller/controladorUsuario.php?opcion=getAll";
 ...
 function aplicarFiltro() {
     ...
     if (filtroId.trim() === "") {
         ...
         var url = `http://localhost/prueba/controller/controladorUsuario.php?opcion=getUser&id=${filtroId}`;
